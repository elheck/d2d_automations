...
### 2. Dead-stock liquidation planner
...
### 3. Buy Helper × own-stock/demand cross-check
...
### 4. Inventory turnover & cash-flow dashboard
...
### 5. Concentration & exposure report
...
### 6. Average sale price vs. current listing price
